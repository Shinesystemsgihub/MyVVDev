...
if ( ! class_exists( 'MVVPS_Debug_Log' ) ) {
	/**
	 * Class MVVPS_Debug_Log.
	 */
	class MVVPS_Debug_Log {

		/** Main instance.
		 *
		 * @var MVVPS_Debug_Log The single instance of the class.
		 */
		...
		/**
		 * Main MVVPS_Debug_Log Instance.
		 *
		 * Ensures only one instance of MVVPS_Debug_Log is loaded or can be loaded.
		 *
		 * @since 2.7.2
		 * @static
		 * @return MVVPS_Debug_Log Main instance
		 */
