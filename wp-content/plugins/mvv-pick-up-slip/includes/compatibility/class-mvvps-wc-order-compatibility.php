...
if ( ! class_exists( 'MVVPS_WC_Order_Compatibility' ) ) :
	 ...
	 * @since 4.6.0
	 */
	class MVVPS_WC_Order_Compatibility extends MVVPS_WC_Data_Compatibility {
			...
			if ( MVVPS_WC_Core_Compatibility::is_wc_version_gte_3_0() ) {
				...
				if ( $date = $order->$prop ) {
					...
					try {
						...
						$date = new MVVPS_WC_DateTime( $date, new DateTimeZone( wc_timezone_string() ) );
		...
		public static function get_prop( $object, $prop, $context = 'edit', $compat_props = array() ) {
			...
			if ( MVVPS_WC_Core_Compatibility::is_wc_version_lt_3_0() ) {
