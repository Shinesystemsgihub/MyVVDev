...
if ( ! class_exists( 'MVVPS_WC_Product_Compatibility' ) ) :
	 ...
	 * @since 4.6.0
	 */
	class MVVPS_WC_Product_Compatibility extends MVVPS_WC_Data_Compatibility {
		...
		public static function get_prop( $object, $prop, $context = 'edit', $compat_props = array() ) {
			...
			if ( MVVPS_WC_Core_Compatibility::is_wc_version_lt_3_0() && 'parent_id' === $prop ) {
				$prop    = 'id';
