...
class ComposerStaticInit94c7f0816fa203ee4c190ff0bde4f23b
{
    ...
    public static $classMap = array (
        'MVVPS_Abstract_Document' => __DIR__ . '/../..' . '/includes/abstracts/abstract-mvvps-document.php',
        'MVVPS_Abstract_Invoice' => __DIR__ . '/../..' . '/includes/abstracts/abstract-mvvps-invoice.php',
        'MVVPS_Abstract_Setting' => __DIR__ . '/../..' . '/includes/abstracts/abstract-mvvps-setting.php',
        /*'MVVPS_Admin_Notices' => __DIR__ . '/../..' . '/includes/admin/class-mvvps-admin-notices.php',*/
        'MVVPS_Debug_Log' => __DIR__ . '/../..' . '/includes/class-mvvps-debug-log.php',
        /*'MVVPS_General_Settings' => __DIR__ . '/../..' . '/includes/admin/settings/class-mvvps-admin-settings-general.php',*/
        'MVVPS_Invoice' => __DIR__ . '/../..' . '/includes/class-mvvps-invoice.php',
        'MVVPS_Packing_Slip' => __DIR__ . '/../..' . '/includes/class-mvvps-packing-slip.php',
        'MVVPS_Template' => __DIR__ . '/../..' . '/includes/class-mvvps-template.php',
        /*
        'MVVPS_Template_Settings' => __DIR__ . '/../..' . '/includes/admin/settings/class-mvvps-admin-settings-template.php',
        */
        'MVVPS_WC_Core_Compatibility' => __DIR__ . '/../..' . '/includes/compatibility/class-mvvps-wc-core-compatibility.php',
        'MVVPS_WC_Data_Compatibility' => __DIR__ . '/../..' . '/includes/compatibility/abstract-mvvps-wc-data-compatibility.php',
        'MVVPS_WC_DateTime' => __DIR__ . '/../..' . '/includes/compatibility/class-mvvps-wc-datetime.php',
        'MVVPS_WC_Order_Compatibility' => __DIR__ . '/../..' . '/includes/compatibility/class-mvvps-wc-order-compatibility.php',
        'MVVPS_WC_Product_Compatibility' => __DIR__ . '/../..' . '/includes/compatibility/class-mvvps-wc-product-compatibility.php',
        'BE_WooCommerce_PDF_Invoices' => __DIR__ . '/../..' . '/includes/mvv-pick-up-slip.php',
