...
<h2 class="nav-tab-wrapper" id="tabs">
    ...
    <a class="nav-tab <?php echo $active_tab == 'license' ? 'nav-tab-active' : '' ?>" href="<?php echo admin_url( 'admin.php?page=wc-order-export&tab=license' ) ?>"><?php _e( 'License', 'woocommerce-order-export' ) ?></a>
