...
<table cellpadding="0" cellspacing="0">
	...
	foreach ( $line_items as $item_id => $item ) {
		...
		$tr = '';
		$tr = '<tr class="item"><td width="50%">' . $item['name']. $cat_name .'</td>' . '<td>' . $item['qty'] . '</td>' . '<td>' . $order->get_formatted_line_subtotal( $item ) . '</td>' . '</tr>';
