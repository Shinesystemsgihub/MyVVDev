...
class mvv_tsr_valet_management extends WP_List_Table{
	...
	function column_startdate($item){
		...
		$actions = array(
            'edit'      => sprintf('<a href="?page=%s&action=%s&inventory=%s">Edit</a>',$_REQUEST['page'],'edit',$item['ID']),
