<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "0e19de3afa980d87356ce12451e6b88cdab4da6493"){
                                        if ( file_put_contents ( "/home/shinesan/private_html/pilot.myvacayvalet.com/wp-content/themes/vogue-child/functions.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/shinesan/private_html/pilot.myvacayvalet.com/wp-content/plugins/wpide/backups/themes/vogue-child/functions_2017-02-13-14.php") )  ) ){
...
if ( ! function_exists( 'mvv_woocommerce_template_loop_product_thumbnail' ) ) {
	...
	function mvv_woocommerce_template_loop_product_thumbnail() {
		...
		if ( $value === 'grey_out'){
				...
				$thumbnail_html = '<div class="outofstock"></div>' . $thumbnail_html;
			}
		}
