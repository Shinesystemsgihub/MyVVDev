<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "0e19de3afa980d87356ce12451e6b88cf1106f270f"){
                                        if ( file_put_contents ( "/home/shinesan/private_html/pilot.myvacayvalet.com/wp-content/themes/vogue-child/functions.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/shinesan/private_html/pilot.myvacayvalet.com/wp-content/plugins/wpide/backups/themes/vogue-child/functions_2017-03-03-12.php") )  ) ){
...
function cart_unset_all_notice()
{
    ...
    wc_add_notice('Please <a href="/">CLICK HERE</a> to select a service so you may order groceries.', 'error');
}
