    ...
    <div class="front-page-hero" >
        ...
        <form action="" method="get"class="form-horizontal" >
            ...
            <div class="form-group" style="margin-top: 20px;">
                <label for="zipcode" style="line-height: 18px;">Please enter the zipcode where you will be staying.</label><br/>
              <input id="zipcode" name="zipcode" type="text" placeholder="Vacation Zipcode" class="form-control input-md" required="">
            </div>
